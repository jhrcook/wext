...
It was found empirically that iterating this process $Q \times |G(E)|$, where Q is the number of random graphs you want in total and $|G(E)|$ is the number of edges, if sufficient.
